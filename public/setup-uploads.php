...
$dirs = ['slides', 'blog', 'products', 'services', 'pages', 'about', 'partners', 'team', 'images', 'site'];
$results = [];
$errors = [];

// Use public/assets/uploads directory structure (works for both local and shared hosting)
